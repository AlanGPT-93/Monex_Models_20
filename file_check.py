...
def revision_archivos(label_result, ruta, anio, mes):
    ...
    try:
        ...
        time.sleep(2)
        label_result.config(text="Ruta o archivo inexistente", bg="red") # En caso de no poder leer el archivo
    ...
    # Si el archivo se leyó, se toma el valor de la posición [4,2]
    ...
    #print(Ruta_Output)
    time.sleep(1)
    label_result.config(text="Terminado", bg="green")