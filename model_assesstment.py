...
def ejecucion_modelo(label_result, ruta, anio, mes):
...
#################################################
    ...
    try:
        ...
        time.sleep(2)
        label_result.config(text="Ruta o archivo inexistente", bg="red")

    # Si el archivo se leyó, se toma el valor de la posición [0,2]
    Ruta_Catalogo_Campos = Rutas_aux.iloc [0, 2]
    Ruta_Catalogo_Campos = Ruta_Catalogo_Campos.replace("\\","/") # Se reemplaza '\' por '/'
    
    # Si el archivo se leyó, se toma el valor de la posición [1,2]
    Ruta_Catalogo_Campos_Rename = Rutas_aux.iloc [1, 2]
    Ruta_Catalogo_Campos_Rename = Ruta_Catalogo_Campos_Rename.replace("\\","/") # Se reemplaza '\' por '/'
